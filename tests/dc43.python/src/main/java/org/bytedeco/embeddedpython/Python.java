...
public class Python {
	...
	private static void init() throws IOException {
		...
		System.out.println("Python init-0: " + (System.currentTimeMillis() - start) + "ms");

		File[] packages = org.bytedeco.cpython.presets.python.cachePackages();
		Py_AddPath(packages);
		// Py_AddPath(org.bytedeco.numpy.presets.numpy.cachePackages());
		System.out.println("Python init-1: " + (System.currentTimeMillis() - start) + "ms");

		if (javaCppVersion.equals("1.5.3") || javaCppVersion.equals("1.5.4")) {
			Py_AddPath(new File(packages[0], "site-packages"));
		}

		System.out.println("Python init-2: " + (System.currentTimeMillis() - start) + "ms");
		...
		System.out.println("Python init-3: " + (System.currentTimeMillis() - start) + "ms");
	}
